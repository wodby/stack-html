# HTML stack for Wodby

Deploy HTML on Kubernetes with Wodby. This repository contains the stack
manifests used by the public HTML stack in the Wodby catalog.

- [HTML stack in the Wodby catalog](https://wodby.com/stacks/html)
